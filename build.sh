...
pacman -R --noconfirm mingw-w64-cross-gcc mingw-w64-cross-mingwarm64-gcc || true
pacman -R --noconfirm mingw-w64-cross-cross-winpthreads mingw-w64-cross-mingwarm64-winpthreads || true
pacman -R --noconfirm mingw-w64-cross-cross-crt mingw-w64-cross-mingwarm64-crt || true
pacman -R --noconfirm mingw-w64-cross-windows-default-manifest mingw-w64-cross-mingwarm64-windows-default-manifest || true
pacman -R --noconfirm mingw-w64-cross-mingwarm64-gcc-stage1 || true
pacman -R --noconfirm mingw-w64-cross-binutils mingw-w64-cross-mingwarm64-binutils || true
pacman -R --noconfirm mingw-w64-cross-headers mingw-w64-cross-mingwarm64-headers || true
